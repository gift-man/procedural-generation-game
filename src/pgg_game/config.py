...
COLORS = {
    ...
    # ... существующие цвета ...
    'province_neutral': (200, 200, 200),  # Цвет нейтральной провинции
    'province_border': (100, 100, 100),   # Цвет границы провинции
    'background': (30, 30, 30),           # Цвет фона панелей
...
# Параметры генерации провинций
PROVINCE_GENERATION = {
    'MIN_PROVINCE_SIZE': 4,          # Минимальный размер провинции в клетках
    'MAX_PROVINCE_SIZE': 8,          # Максимальный размер провинции в клетках
    'MIN_PROVINCES': 5,              # Минимальное количество провинций
    'MAX_PROVINCES': 7,              # Максимальное количество провинций
    'MAX_GENERATION_ATTEMPTS': 50    # Максимальное количество попыток генерации
}